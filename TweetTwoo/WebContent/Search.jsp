...
<jsp:include page="Header.jsp" />
	...
	<!-- Div contains form for searching for user -->
	<div class="timeline">
	...
	<div class="timeline">
		...
		<!-- Div displays searched for users info -->
		<div class="tweetDiv"> 
				 <br/>
				...
				<span class="tweetFont" style="margin-left:2%;float:left;"><%=md.getLocation() %>,<%=md.getCountry() %></span><br>
					<!--  if they are following searched user enable them to unfollow -->
					<%
					...
					<!-- Depending on permissions enable user to delete account -->
					<%
